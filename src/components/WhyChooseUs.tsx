import { Leaf, Palette, Clock, ShieldCheck } from "lucide-react";
  ...
  <section className="py-20 md:py-28 bg-primary">
    <div className="container">
      <div className="text-center mb-14">
        ...
        <h2 className="font-heading text-3xl md:text-4xl font-bold text-primary-foreground">Why Choose 12AM Stories</h2>
      </div>
      ...
      <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-8">
        {features.map((f) => (
          <div key={f.title} className="text-center group">
            ...
            <h3 className="font-heading text-lg font-semibold text-primary-foreground mb-2">{f.title}</h3>
